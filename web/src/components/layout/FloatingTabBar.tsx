...
export function FloatingTabBar({ activeTab, onChangeTab }: FloatingTabBarProps) {
  ...
  return (
    <nav className="bg-[#13151A]/90 backdrop-blur-xl border border-white/10 p-1.5 rounded-full shadow-2xl shadow-black/80 flex items-center gap-1">
      {tabs.map(tab => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-1.5 px-3.5 py-2.5 rounded-full transition-all duration-200 cursor-pointer ${
              isActive
