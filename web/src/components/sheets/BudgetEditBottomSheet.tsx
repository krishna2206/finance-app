...
import { CloseLinearIcon, TrashBinTrashLinearIcon } from '@solar-icons/react';
  ...
  return (
    <>
          ...
          >
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                >
                  <TrashBinTrashLinearIcon size={17} />
                </button>
                <button
                  onClick={onClose}
      ...
      <ConfirmationModal
        ...
        title={`Supprimer l'enveloppe "${category.name}" ?`}
        message="Cette action est irréversible. Les transactions associées à cette catégorie conserveront leur historique."
