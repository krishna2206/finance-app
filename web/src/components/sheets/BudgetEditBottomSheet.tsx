    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex justify-center items-end sm:items-center">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md bg-[#13151A] rounded-t-[32px] sm:rounded-[32px] border border-white/10 p-6 shadow-2xl z-10"
        >
          {/* Header */}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="bg-[#090A0C] border border-white/10 rounded-2xl p-4 flex items-baseline justify-center gap-2 mb-6">
              <input
                autoFocus
                type="number"
                value={budgetInput}
                ...
                placeholder="0"
                className="text-3xl font-bold text-zinc-50 bg-transparent text-center focus:outline-none w-48 tabular-nums tracking-tight"
              />
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={onClose}
                className="w-full bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-semibold py-3.5 rounded-2xl text-xs uppercase tracking-wider transition-colors cursor-pointer"
              >
                Annuler
              </button>
              ...
              <button
                ...
                className="w-full bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold py-3.5 rounded-2xl text-xs uppercase tracking-wider transition-colors shadow-lg shadow-emerald-500/20 cursor-pointer"
              >
